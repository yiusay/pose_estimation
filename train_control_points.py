import sys
# This seems to be necessary to import opencv corrrectly. It seeems ros has some problem. 
...
for i in range(num_parts):
	...
	img_paths = sorted(glob.glob(os.path.join("training", "64x64_" + str(i), "*.png")))
	for img_path in img_paths:
		X.append(cv2.imread(img_path, cv2.IMREAD_GRAYSCALE))

	file_name = "training/projected_control_points_" + str(i) + ".data"
